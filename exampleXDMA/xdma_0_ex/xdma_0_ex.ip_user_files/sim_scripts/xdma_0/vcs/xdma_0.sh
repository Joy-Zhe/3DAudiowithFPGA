...
design_libs=(xilinx_vip xpm xil_defaultlib blk_mem_gen_v8_4_6 fifo_generator_v13_1_4 xdma_v4_1_23)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_1_4 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xdma_v4_1_23 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/ipshared/03b2/hdl/xdma_v4_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
