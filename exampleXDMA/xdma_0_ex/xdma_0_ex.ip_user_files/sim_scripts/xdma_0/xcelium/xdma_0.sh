...
#
# Script generated by Vivado on Sat Oct 28 14:50:47 +0800 2023
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname blk_mem_gen_v8_4_6 -libname fifo_generator_v13_1_4 -libname xdma_v4_1_23 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib blk_mem_gen_v8_4_6 fifo_generator_v13_1_4 xdma_v4_1_23)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "xdma_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work fifo_generator_v13_1_4 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/fifo_generator_vlog_beh.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvhdl -work fifo_generator_v13_1_4 $xmvhdl_opts \
  ...
  xmvlog -work xdma_v4_1_23 $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/ipshared/03b2/hdl/xdma_v4_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"../../../ipstatic/ipshared/03b2/hdl/verilog" +incdir+"D:/Software/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
